...
public class NewDrinksPage extends JFrame implements ActionListener {
	...
	//constructor
	public NewDrinksPage(SqlHolder sqlInf,String user_id){
		...
		String new1 = "'%" + String.valueOf(year) + "/" + String.valueOf(month) + "%'";
		String new2 = "'%" + String.valueOf(year) + "/" + String.valueOf(month-1) + "%'";
		String new3 = "'%" + String.valueOf(year) + "/" + String.valueOf(month-2) + "%'";
		
		newDrinkQuery("SELECT drink_id, drink_name, price, temparature FROM drink WHERE release_date LIKE " +new1+ " OR release_date LIKE " +new2+ " OR release_date LIKE " +new3);
	...
	public void newDrinkQuery(String sql) {
	...
	public void insertPickedListQuery(String user_id, String drink_id) {
		...
		try{ 
		      ...
		      stmt.executeUpdate("INSERT INTO pickedList VALUES (" + user_id + ", " + drink_id + ")");   
